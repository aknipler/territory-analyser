...
## To - Do
- Implement forests to be placed above players
- Implement closed shape analysis 
- Implement hole in wall check
- Implement enemy in closed shape exception proof
...
- Solve water (more broadly, maybe apply to non-buildable terrain)? Closed shape on land, docks give a small area around them? Castles, towers and TCs still give territory on water?
